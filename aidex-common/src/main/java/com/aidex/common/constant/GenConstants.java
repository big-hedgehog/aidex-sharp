...
public class GenConstants {
     ...
     * 页面常用字段
     */
    public static final String[] COLUMNNAME_COMMON_COLUMN = {"sort" , "status" , "remark" , "id" , "create_by" , "create_dept" , "create_time" , "update_by" , "update_time" , "update_ip" , "version" , "del_flag"};

    /**
     * 页面不需要显示的列表字段
     */
    public static final String[] COLUMNNAME_NOT_LIST = {"id" , "create_by" , "create_dept" , "create_time" , "update_by" , "update_time" , "update_ip" , "remark" , "version" , "del_flag"};
